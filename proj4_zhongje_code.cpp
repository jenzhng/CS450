...
const char *WINDOWTITLE = "OpenGL / GLUT Project 4 -- Jenny Zhong";
...
Display( )
{
	...
	HsvRgb(hsv, rgb);
	glPushMatrix();
		glTranslatef(0., Ypos.GetValue(nowTime), Xpos1.GetValue(nowTime));
		SetMaterial(hsv[0], 0.f, 0.f, 120.);
		SetMaterial(hsv[0], 1., 0., 120.);
		SetMaterial(hsv[0], 1., 0., 120.);
		SetMaterial(hsv[0], 0., 1., 120.);
		glRotatef(360.f * Time, 0., 0., 1.);
		//gluLookAt(0.f, 0.f, Eye.GetValue(nowTime), 0.f, 0.f, 0.f, 0.f, 1.f, 0.f);

		SetPointLight(GL_LIGHT0, Xpos1.GetValue(nowTime), 0., 0., 0., 1., 0.);
		glTranslatef(0., 0., Xpos1.GetValue(nowTime));
		glRotatef(90., 1., 0., Zrotate.GetValue(nowTime));
...
InitGraphics( )
{
	...
	Zrotate.Init();
	Zrotate.AddTimeValue(0.0, 0.000);
	Zrotate.AddTimeValue(0.5, 2.718);
	Zrotate.AddTimeValue(2.0, 3.333);
	Zrotate.AddTimeValue(5.0, 2.142);
	Zrotate.AddTimeValue(8.0, 1.718);
	Zrotate.AddTimeValue(10.0, 0.000);
	...
	Ypos.AddTimeValue(5.0, 3.142);
	Ypos.AddTimeValue(8.0, 2.718);
	Ypos.AddTimeValue(10.0, 0.000);

	Hue.Init();
	Hue.AddTimeValue(0.0, 0.000);
	Hue.AddTimeValue(0.5, 1.0);
	Hue.AddTimeValue(2.0, 0.5);
	Hue.AddTimeValue(5.0, 0.0);
	Hue.AddTimeValue(8.0, 1.0);
	Hue.AddTimeValue(10.0, 0.0);

	Eye.Init();
	Eye.AddTimeValue(0.0, 0.000);
	Eye.AddTimeValue(0.5, 2.0);
	Eye.AddTimeValue(2.0, 1.0);
	Eye.AddTimeValue(5.0, 0.0);
	Eye.AddTimeValue(8.0, -2.0);
	Eye.AddTimeValue(10.0, 0.0);
...
InitLists( )
{
	...
	SetMaterial(0.6f, 0.6f, 0.6f, 125.f);
	glNormal3f(0., 1., 0.);
	for (int i = 0; i < NZ; i++)
	{
